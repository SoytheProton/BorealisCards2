...
public sealed class VitrificationPower : BorealisCards2Power
{
    ...
    {
        if (creator == null || creator.Creature != Owner || card.Keywords.Contains(CardKeyword.Retain) || card.EnergyCost.GetWithModifiers(CostModifiers.All) < Vitrification.VitrificationAmount)
