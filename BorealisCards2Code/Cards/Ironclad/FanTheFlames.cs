...
public sealed class FanTheFlames() : BorealisCards2Card(1,
    ...
    TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<FanTheFlamesPower>(6M)];
    ...
    protected override void OnUpgrade() => DynamicVars.Power<FanTheFlamesPower>().UpgradeValueBy(3M);
}